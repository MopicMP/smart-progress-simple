# smart-progress-simple

> Smart minimal progress bar for loops

[![PyPI version](https://badge.fury.io/py/smart-progress-simple.svg)](https://pypi.org/project/smart-progress-simple/)
...
```bash
pip install smart-progress-simple
```
...
result = simple("Hello World")

# Example 2: Batch processing
from smart_progress_simple import batch
